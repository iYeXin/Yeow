...
const entries = [
    {
        link: '/overview',
        title: 'Overview',
        desc: 'Guided by role: Beginner / Developer / Admin / Platform Implementer',
        icon: 'compass',
    },
    {
        link: '/getting-started',
        title: 'Quick Start',
        desc: 'Create a project, your first plugin, deploy & permissions',
        icon: 'zap',
    },
    {
        link: '/api/',
        title: 'API Reference',
        desc: 'Complete API index grouped by module',
        icon: 'code',
    },
    {
        link: '/advanced',
        title: 'Advanced',
        desc: 'Architecture, threading model, scheduler internals',
        icon: 'layers',
    },
    {
        link: '/specifications/',
        title: 'Specifications',
        desc: 'Protocol-layer definitions for runtime implementers',
        icon: 'terminal',
    },
]
...
const lines = [
    ...
    { cmd: 'cd my-plugin' },
    { cmd: 'npm install' },
    { cmd: 'npm run dev', comment: 'Local server + hot reload' },
    { cmd: 'npm run build', comment: 'Output .jar and .yeow.zip' },
]
</script>
...
<template>
    <div class="yeow-home">
        ...
        <section class="hero">
            ...
            <h1>
                Write <span class="grad">Minecraft</span> plugins<br />
                with <span class="grad">TypeScript</span>
            </h1>
            <p class="subtitle">
                Yeow provides a TypeScript / JavaScript plugin development framework for
                Paper and <a href="https://papermc.io/software/folia/">Folia</a> servers.
                Each plugin runs in its own QuickJS thread, communicating with the game
                thread through a message bridge. <b>One plugin package works on both Paper and Folia.</b>
            </p>
            <div class="cta">
